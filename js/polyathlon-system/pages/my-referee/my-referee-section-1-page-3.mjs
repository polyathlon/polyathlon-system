    ...
    render() {
        return html`
            <div class="container">
                ...
                <simple-input id="profileUlid" icon-name="card-id-solid" @icon-click=${this.copyToClipboard} label="Sportsman ulid:" .value=${this.item?.profileUlid} @input=${this.validateInput}></simple-input>
...
customElements.define("my-referee-section-1-page-3", MyRefereeSection1Page3);