...
import './my-club-section-1-page-1.mjs'
import './my-club-section-1-list-1.mjs'

import DataSet from './my-club-dataset.mjs'

import DataSource from './my-club-datasource.mjs'

class MyClubSection1 extends BaseElement {
    ...
    get page1() {
        return html`
            <my-club-section-1-page-1 .oldValues=${this.oldValues} .item=${this.currentItem}></my-club-section-1-page-1>
        `;
    }

    get page2() {
        return html`
            <my-club-section-1-page-2 .oldValues=${this.oldValues} item=${this.currentItem}></my-club-section-1-page-2>
        `;
    }
    ...
    #list1() {
        return html`
            <div class="avatar">
                ${this.isFirst ? html`<avatar-input id="avatar" .currentObject=${this} .avatar=${this.avatar || 'images/club-solid.svg'} @input=${this.validateAvatar}></avatar-input>` : ''}
            </div>
            <div class="label">
    ...
    #list2() {
        return html`
            <my-club-section-1-list-2 .parent=${this.currentItem}></my-club-section-1-list-2>
        `;
    }
    ...
    async getQRCode() {
        const dataURI = await DataSet.getQRCode(location.origin+`/system?club=${this.currentItem._id.split(':')[1]}#my-club`)
...
customElements.define("my-club-section-1", MyClubSection1);