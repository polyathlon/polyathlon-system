...
class MyFederationMembersSection1PageSearch extends BaseElement {
...
customElements.define("my-federation-members-section-1-page-search", MyFederationMembersSection1PageSearch)