    ...
    render() {
        return html`
            <div class="container">
                ...
                <simple-input id="federationMemberId" label="${lang`Federation Member ID`}:" icon-name="id-number-solid" button-name="add-solid" @icon-click=${this.copyToClipboard}  @button-click=${this.createHashNumber} .value=${this.item?.federationMemberId} @input=${this.validateInput}></simple-input>
                <div class="name-group">
