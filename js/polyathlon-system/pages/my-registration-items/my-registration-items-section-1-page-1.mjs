    ...
    render() {
        return html`
            <div class="container">
                ...
                <simple-select id="category" label="${lang`Category`}:" icon-name="registration-category-solid" @icon-click=${() => this.showPage('my-registration-items')} .dataSource=${this.registrationCategoryDataSource} .value=${this.item?.category} @input=${this.validateInput}></simple-select>
                ...
                <simple-input id="registrationPC" label="${lang`Federation member PC`}:" icon-name="registration-pc-solid" button-name="add-solid" @icon-click=${this.copyToClipboard}  @button-click=${this.createRegistrationPC} .value=${this.item?.registrationPC} @input=${this.validateInput}></simple-input>
                <div class="name-group">
