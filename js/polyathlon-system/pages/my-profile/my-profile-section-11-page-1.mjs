...
import '../../../../components/inputs/simple-input1.mjs'
    ...
    render() {
        return html`
            <div>
                ...
                <simple-input1 id="lastName" icon-name="flag-solid" label="Flag name:" .value=${this.item?.personalInfo?.lastName} @input=${this.validateInput}></simple-input1>
            </div>
