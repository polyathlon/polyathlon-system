    ...
    render() {
        return html`
            <div class="container">
                ...
                <simple-input id="profileUlid" icon-name="card-id-solid" @icon-click=${this.copyToClipboard} label="${lang`Sportsman ulid`}:" .value=${this.item?.profileUlid} @input=${this.validateInput}></simple-input>
                <simple-input id="hashNumber" icon-name="hash-number-solid" button-name="add-solid" @icon-click=${this.copyToClipboard}  @button-click=${this.createHashNumber} label="${lang`Sportsman number`}:" .value=${this.item?.hashNumber} @input=${this.validateInput}></simple-input>
