    ...
    render() {
        return html`
            <div class="container">
                ...
                <simple-select id="category" icon-name="sportsman-category-solid" @icon-click=${() => this.showPage('my-sports-categories')} label="${lang`Sports category`}:" .dataSource=${this.sportsCategoryDataSource} .value=${this.item?.category} @input=${this.validateInput}></simple-select>
                <div class="name-group">
