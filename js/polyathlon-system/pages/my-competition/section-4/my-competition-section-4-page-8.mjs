...
//   }
    ...
    drawChart(){
        this.chart = new Chart(this.$id('chart'), {
            type: 'bar',
            data: {
              labels: this.dataSource.indexes,
              datasets: [{
                data: this.dataSource.rows.map(value => value[1]),
                label: 'Мужчины',
                hidden: true,
                borderWidth: 1,
              ...
              {
                data: this.dataSource.rows.map(value => value[2]),
                label: 'Женщины',
                hidden: true,
                borderWidth: 1,
              ...
              {
                data: this.dataSource.rows.map(value => value[3]),
                label: 'Итого',
                borderWidth: 1,
