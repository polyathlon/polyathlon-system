...
class MyCompetitionSection4Page6 extends BaseElement {
        ...
        this.chart = new Chart(this.$id('chart'), {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Принадлежность к спортивной школе',
...
customElements.define("my-competition-section-4-page-6", MyCompetitionSection4Page6);