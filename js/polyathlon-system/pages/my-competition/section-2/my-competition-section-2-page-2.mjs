    ...
    render() {
        return html`
            ...
            <div class="container">
                ...
                <simple-input id="place" icon-name="competition-solid" label=${lang`Place` + ':'} .currentObject=${this.item?.shooting} .value=${this.item?.shooting?.place} @input=${this.validateInput}></simple-input>
            </div>
        `;
    }
