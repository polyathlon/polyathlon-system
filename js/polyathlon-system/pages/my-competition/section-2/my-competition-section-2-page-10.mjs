            ...
            return html`
                ...
                <div class="container">
                    <div class="name-group">
                        <simple-input id="flow" icon-name="jumping-solid" label=${lang`Flow` + ':'} .currentObject=${this.item?.jumping} .value=${this.item?.jumping?.flow} @input=${this.validateInput}></simple-input>
