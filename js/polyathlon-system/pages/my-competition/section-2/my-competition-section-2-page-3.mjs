        ...
        return html`
            ...
            <div class="container">
                <div class="name-group">
                    ...
                    <simple-input id="track" icon-name="road-solid" label="Track:" .currentObject=${this.item?.running} .value=${this.item?.running?.track} @input=${this.validateInput}></simple-input>
                </div>
                <div class="name-group">
