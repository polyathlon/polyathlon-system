    ...
    render() {
        return html`
            ...
            <div class="container">
                ...
                <simple-input id="place" icon-name="users-solid" label=${lang`Place` + ':'} .currentObject=${this.item?.sprinting} .value=${this.item?.sprinting?.place} @input=${this.validateInput}></simple-input>
            </div>
        `;
    }
