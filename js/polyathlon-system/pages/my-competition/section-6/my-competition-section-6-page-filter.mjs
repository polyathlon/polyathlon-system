...
class MyCompetitionSection6PageFilter extends BaseElement {
...
customElements.define("my-competition-section-6-page-filter", MyCompetitionSection6PageFilter);