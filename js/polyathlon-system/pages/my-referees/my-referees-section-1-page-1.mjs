    ...
    render() {
        return html`
            <div class="container">
                ...
                <simple-input id="id" icon-name="hash-number-solid" button-name="add-solid" .iconClick=${this.copyToClipboard}  .buttonClick=${this.createHashNumber} label="Referee ID:" .value=${this.item?.hashNumber} @input=${this.validateInput}></simple-input>
                <div class="name-group">
