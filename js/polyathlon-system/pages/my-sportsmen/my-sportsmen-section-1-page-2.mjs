...
class MySportsmenSection1Page2 extends BaseElement {
    ...
    render() {
        return html`
            <div class="container">
                <simple-input id="lastName" label="${lang`Last name`}:" icon-name="user" .value=${this.item?.lastName} @input=${this.validateInput} button-name="search-solid" @button-click=${this.search} @keydown=${this.searchClick}></simple-input>
