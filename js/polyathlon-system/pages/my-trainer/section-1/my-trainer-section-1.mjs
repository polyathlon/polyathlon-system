...
class MyCompetitionSection1 extends BaseElement {
    ...
    #page2() {
        return html`
            <my-trainer-section-1-page-2 .item=${this.currentItem}></my-trainer-section-1-page-2>
        `;
    }

    #page3() {
        return html`
            <my-trainer-section-1-page-3 .item=${this.currentItem}></my-trainer-section-1-page-3>
        `;
    }
    ...
    #list1() {
        return html`
            <my-trainer-section-1-list-1 .avatar=${this.avatar} .item=${this}></my-trainer-section-1-list-1>
        `;
    }

    #list3() {
        return html`
            <my-trainer-section-1-list-3 .parent=${this.currentItem}></my-trainer-section-1-list-3>
        `;
    }
...
customElements.define("my-trainer-section-1", MyCompetitionSection1);