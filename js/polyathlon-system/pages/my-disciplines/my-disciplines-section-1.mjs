...
import './my-disciplines-section-1-page-1.mjs'

import DataSet from './my-disciplines-dataset.mjs'
import DataSource from './my-disciplines-datasource.mjs'

class MyDisciplinesSection1 extends BaseElement {
    ...
    update(changedProps) {
        ...
        if (changedProps.has('currentDisciplinesItem')) {
            this.currentPage = 0;
        }
    }
    ...
    #page1() {
        return html`
            <my-disciplines-section-1-page-1 .oldValues=${this.oldValues} .item=${this.currentItem}></my-disciplines-section-1-page-1>
        `;
    }

    #page2() {
        return html`
            <my-disciplines-section-1-page-2 .item=${this.currentItem}></my-disciplines-section-1-page-2>
        `;
    }
...
customElements.define("my-disciplines-section-1", MyDisciplinesSection1);