...
class VerifyEmailForm extends BaseElement {
                ...
                <form class="form animate" method="post" id="form">
                    <div class="form-header">
                        <div class="form-tabs no-select">
                            <div class="form-tab" selected data-label="Password recovery">Verify Email</div>
                        </div>
                    ...
                    <div class="form-body">
                        <div id="db-tab-section" class="form-tab-section selected">
                            ...
                            <form-button ?disable=${!this.isCodeEnable()} @click=${this.isCodeEnable() ? this.verifyEmail : nothing}>Verify Email</form-button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    async verifyEmail() {
        ...
        let response = await VerifyEmailForm.fetchVerifyEmail({ code }, this.token )
...
customElements.define("verify-email-form", VerifyEmail);
