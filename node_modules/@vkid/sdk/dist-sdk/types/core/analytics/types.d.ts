...
type RegistrationStatsEventTypes = 'iframe_loading_failed' | 'no_session_found' | 'onetap_button_no_user_show' | 'onetap_button_no_user_tap' | 'screen_proceed' | 'no_user_button_show' | 'no_user_button_tap' | 'multibranding_oauth_added' | 'vk_button_show' | 'ok_button_show' | 'mail_button_show' | 'vk_button_tap' | 'ok_button_tap' | 'mail_button_tap' | 'custom_auth_start';
